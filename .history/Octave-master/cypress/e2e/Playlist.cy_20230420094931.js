describe('Testing playlist page', () => {
  ...
  it('Can play a song in the playlist', () => {
    ...
    // Click the button
    cy.get('#root > div > div > div.app__window > div > div.playlist__container > div > div:nth-child(3) > button').click();
...
it('Can make a song play next', () => {
  ...
  // Click the button
  cy.get('#root > div > div > div.app__window > div > div.playlist__container > div > div.playlistsong__options > button').click();
